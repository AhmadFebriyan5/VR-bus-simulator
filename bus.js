...
// Dasbor VR Interaktif (Untuk interaksi tatap kursor dalam VR)
...
function buildBus() {
  ...
  const bodyLower = new THREE.Mesh(new THREE.BoxGeometry(3, 1.0, 8), mat(0x0044cc)); // Biru bawah
  bodyLower.position.y = 1.0; bodyLower.castShadow = true;
  busGroup.add(bodyLower);

  const bodyUpper = new THREE.Mesh(new THREE.BoxGeometry(3, 1.0, 7.8), mat(0xf0f0f0)); // Putih atas
