...
stops.forEach((z) => {
  ...
  // Atap Biru Khas Halte Trans Musi
...
// ─── DEKORASI TIANG LAMPU JALAN NEON ──────────────────────────────
const roadLights = [];
for (let z = -180; z < 200; z += 30) {
  ...
  scene.add(pl);
  roadLights.push(pl); // Kumpulkan untuk kontrol nyala malam hari
}
